...
export default function ConfigPage() {
    ...
    const API = (process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000") + "/api/config";
        ...
        <div className="min-h-screen bg-gray-900 text-white p-8">
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-3xl font-bold">⚙️ Factory Settings</h1>
                </div>

                {/* Schedule Toggle */}
                <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 mb-6 flex justify-between items-center">
                    <div>
                        <h2 className="text-xl font-semibold">Auto-Run Schedule</h2>
                        <p className="text-gray-400 text-sm">Run crawler every morning at 9:00 AM</p>
                    </div>
                    <button
                    ...
                    >
                        {config.auto_schedule ? 'ON' : 'OFF'}
                    </button>
                </div>

                {/* URL List */}
                <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
                    <h2 className="text-xl font-semibold mb-4">Target URLs (Auto-Crawl)</h2>
                    ...
                    <div className="flex gap-2 mb-4">
                        <input
                            ...
                            placeholder="Add Olive Young Category URL..."
                    ...
                    <ul className="space-y-2">
                        {config.target_urls.length === 0 ? (
                            <li className="text-gray-500 text-center py-4">No URLs configured.</li>
                        ) : (
